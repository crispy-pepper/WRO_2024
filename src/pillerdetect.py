...
while True:
    ...
    contours_red, hierarchy = cv2.findContours(img_thresh_red[ROI_MIDDLE[1]:ROI_MIDDLE[3], ROI_MIDDLE[0]:ROI_MIDDLE[2]],
        cv2.RETR_EXTERNAL, cv2.CHAIN_APPROX_NONE)
   
    
    contours_green, hierarchy = cv2.findContours(img_thresh_green[ROI_MIDDLE[1]:ROI_MIDDLE[3], ROI_MIDDLE[0]:ROI_MIDDLE[2]],
        cv2.RETR_EXTERNAL, cv2.CHAIN_APPROX_NONE)
    ...
    contours = [(contours_red,(0,0,255),1),(contours_green,(0,255,0),1)]
